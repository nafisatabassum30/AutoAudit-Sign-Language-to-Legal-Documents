...
OUTPUT_DIR = "output/sign_sentence_v3_final_cnn_bilstm_attention"
RESULT_DIR = "outputs/sign_sentence_v3_final_cnn_bilstm_attention"

MODEL_PATH = os.path.join(OUTPUT_DIR, "sign_sentence_v3_final_model.pt")
...
def main():
    ...
    print("=" * 70)
    print("AutoAudit v3 FINAL: CNN + BiLSTM + Attention")
    print("=" * 70)
    print("Device:", device)
    if device.type == "cuda":
    ...
    model_config = {
        "architecture": "CNN-BiLSTM-Attention-v3-final",
    ...
    for epoch in range(1, NUM_EPOCHS + 1):
        ...
        # If validation is stuck because classes are very sparse, still save stronger train model.
        if train_metrics["accuracy"] > best_train_acc and epoch >= 5:
            best_train_acc = train_metrics["accuracy"]
            should_save = True
    ...
    print("Best train acc:", round(best_train_acc, 4))
