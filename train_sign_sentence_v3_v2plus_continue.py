...
OUTPUT_DIR = Path("output/sign_sentence_v3_v2plus_cnn_attention_continue")
RESULT_DIR = Path("outputs/sign_sentence_v3_v2plus_cnn_attention_continue")
...
def main():
    ...
    # Load previous best 35-epoch v3 v2plus checkpoint and continue training
    load_model_path = "output/sign_sentence_v3_v2plus_cnn_attention/sign_sentence_v3_v2plus_cnn_attention_model.pt"
    print("Loading previous checkpoint:", load_model_path)
    ...
    print("Checkpoint loaded. Continuing training with lower LR.")
    ...
    best_val_acc = 0.09973404255319149
    history = []
    ...
    for epoch in range(1, NUM_EPOCHS + 1):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save({
                ...
                "epoch": epoch
            }, OUTPUT_DIR / "sign_sentence_v3_v2plus_cnn_attention_continue_model.pt")

            print("Saved best model.")

    # Load best model for final test
    checkpoint = torch.load(OUTPUT_DIR / "sign_sentence_v3_v2plus_cnn_attention_continue_model.pt", map_location=device)
    model.load_state_dict(checkpoint["model_state_dict"])
